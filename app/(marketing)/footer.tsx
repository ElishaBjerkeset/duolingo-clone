...
export const Footer = () => {
    return (
        <footer className="hidden lg:block h-20 w-full border-t-2 border-slate-200 p-2">
            <div className="max-w-screen-lg mx-auto flex items-center justify-evenly gap-2 h-full">
                <Button size="lg" variant="ghost" >
                    <Image src="/no.svg" alt="Norwegian" height={32} width={40} className="mr-4 rounded-md"/>
                    Norwegian
                </Button>
                <Button size="lg" variant="ghost" >
